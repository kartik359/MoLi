# 🎉 MoLi - Fast and Efficient Molang Runtime
...
1. **Input Expressions:** Type your Molang expressions directly into the application interface or pass them as command-line arguments.

2. **Evaluate Results:** MoLi will return the results based on your input. You can use these results for your projects or experiments.

3. **Explore Examples:** For beginners, check the MoLi documentation for example expressions to try.
...
## ⚙️ Contributing to MoLi

Do you want to help improve MoLi? Here's how:

1. **Fork the Project:** Use the Fork button on GitHub to create your own copy of MoLi.
2. **Make Changes:** Edit the code as you see fit. 
3. **Submit a Pull Request:** Once you’re ready, submit your changes back to the main project for review.
